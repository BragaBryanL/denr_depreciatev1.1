...
function Login({ onLogin, initialLoginType = 'user' }) {
  const [loginType, setLoginType] = useState(initialLoginType); // 'admin' or 'user'
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-200 via-emerald-200 to-teal-200 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="max-w-md w-full relative z-10">
        {/* Login Type Selector - Only show if not forced by URL */}
        {!initialLoginType && (
          <div className="mb-6">
