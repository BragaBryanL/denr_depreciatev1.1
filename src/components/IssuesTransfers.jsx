...
import { Plus, Search, Filter, Download, Edit, Trash2, FileText, ArrowRightLeft } from 'lucide-react';
    ...
    <div className="p-6">
          ...
          <table className="w-full" ref={tableRef}>
            <thead className="bg-gray-50 dark:bg-gray-700">
              <tr>
                ...
                <th className="px-4 py-3 text-left text-sm font-medium text-gray-700 dark:text-gray-300">Accountable User</th>
      ...
      <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} title={editingTransaction ? 'Edit Transaction' : 'Add Transaction'}>
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Property Number</label>
            <input
              type="text"
              name="propertyNumber"
              ...
              required
              className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-denr-green dark:bg-gray-700 dark:text-gray-300"
              placeholder="Enter property number"
            />
          </div>

          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Accountable User</label>
            <input
              type="text"
              ...
              required
              className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-denr-green dark:bg-gray-700 dark:text-gray-300"
              placeholder="Enter accountable user name"
            />
          </div>
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">PAR Number</label>
            <input
              type="text"
              name="parNumber"
          ...
          <div className="flex gap-3 pt-4">
            ...
            <button
              type="submit"
              className="flex-1 px-4 py-2 bg-denr-green text-white rounded-lg hover:bg-green-700 transition-colors"
            >
